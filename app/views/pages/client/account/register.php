               ...
               <div class="ec-login-wrapper">
                   <div class="ec-login-container">
                       <div class="ec-login-form">
                           ...
                           <!-- OTP Form -->
                           <form method="post" id="formOtpRegister" style="display: none;">
                               <div class="form-group mb-3 ">
                                   <label>Mã xác nhận (OTP)</label>
                                   <input type="text" class="form-control mb-0 " id="otpRegister" name="otp" placeholder="Nhập mã OTP 6 số từ email">
                               </div>
                               <span class="ec-login-wrap ec-login-btn ">
                                   <button id="btn_otp" class="btn btn-primary rounded-1" onclick="verifyOtpRegister()" type="button">Xác nhận</button>
                               </span>
                           </form>
                       </div>
                   </div>
