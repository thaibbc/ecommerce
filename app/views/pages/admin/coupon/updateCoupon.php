                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-check">
                                    <input class="form-check-input" value="1" id="public" type="radio" name="status" <?= !isset($dataCoupon['status']) || $dataCoupon['status'] == 1 ? 'checked' : '' ?>>
                                    <label for="public" class="form-check-label">
                                        Công khai
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" value="0" id="hidden" type="radio" name="status" <?= isset($dataCoupon['status']) && $dataCoupon['status'] == 0 ? 'checked' : '' ?>>
